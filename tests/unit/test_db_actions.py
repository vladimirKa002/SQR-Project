...
class TestDBActions(TestProject):
    ...
    def test_create_user(self):
        ...
        user_create = UserCreate(name='Ivanov Ivan', email="test@example.com", password="password")
    ...
    def test_create_template(self):
        ...
        mock_session.query.return_value.where.return_value = [Item(id=1), Item(id=2), Item(id=3)]
    ...
    def test_get_all_templates(self):
        ...
        # Mocking the query result
        mock_session.query.return_value.all.return_value = [Template(id=1, name="Template 1"), Template(id=2, name="Template 2")]
    ...
    def test_get_template(self):
        mock_session = mock.create_autospec(Session)
        mock_session.query.return_value.filter_by.return_value.first.return_value = Template(id=1, name="Template 1")
    ...
    def test_get_tierlist_item(self):
        mock_session = mock.create_autospec(Session)
        mock_session.query.return_value.filter.return_value.first.return_value = TierListItem(tier_list_id=1,
                                                                                              item_id=2,
                                                                                              tier="S")
    ...
    def test_rank_tierlist_item_new_item(self):
        ...
        mock_session.query().filter(and_()).first.return_value = None
        mock_session.add.return_value =None

        result = rank_tierlist_item(item_id, tier_list_id, tier, db=mock_session)
    ...
    def test_delete_tierlist_item(self):
        ...
        item_id = 1
        tier_list_id = 1
        tier_list_item = TierListItem(item_id=item_id, tier_list_id=tier_list_id)
        mock_session.query().filter(and_()).first.return_value = tier_list_item
        mock_session.commit.return_value = None
    ...
    def test_get_all_tierlists(self):
        mock_session = mock.create_autospec(Session)
        user_id = 1
        tier_lists = [TierList(id=1, user_id=2, template_id=3), TierList(id=2, user_id=5, template_id=6)]
    ...
    def test_get_tierlist(self):
        ...
        mock_session.query().filter(and_()).first.return_value = tier_list
